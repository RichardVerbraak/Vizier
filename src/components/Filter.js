		...
		return (
			<>
				<input
					...
					id='category__dropdown-toggle'
				/>
				<label
					className='category__dropdown'
					htmlFor='category__dropdown-toggle'
				>
					<p className='category__dropdown-current selected'>
					...
					<ul className='category__dropdown-list'>
						<NavLink
							to={`/discover/popular/${this.props.media}`}
							className='category__dropdown-list--item'
							activeClassName='selected'
						>
							Popular
						</NavLink>
						<NavLink
							to={`/discover/top_rated/${this.props.media}`}
							className='category__dropdown-list--item'
							activeClassName='selected'
						>
							Top Rated
						...
						{this.props.media !== 'tv' && (
							<NavLink
								to={`/discover/upcoming/${this.props.media}`}
								className='category__dropdown-list--item'
								activeClassName='selected'
							>
								Upcoming
