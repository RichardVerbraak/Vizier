        ...
        <div className="movie">
            ...
            <div className="movie__content">
                ...
                <div className="movie__heading">
                    <h1 className="movie__heading-main">{props.details.title}</h1>
                    <h2 className="movie__heading-sub">{props.details.tagline}</h2>
                </div>
                        
                <div className="movie__details">
                    <p className="movie__details--genre">Drama | Crime</p>
                    <p className="movie__details--score">{props.details.vote_average} / 10</p>
                    <p className="movie__details--runtime">{props.details.runtime}min</p>
                </div>
                ...
                <div className="movie__links">
                    ...
                    <a className="movie__links--watchlist btn btn__imdb" href={`https://www.imdb.com/title/${props.details.imdb_id}/`}>IMDB</a>
