...
// 		dispatch(loading())
// 		fetch(
// 			`https://api.themoviedb.org/3/tv/${filter}?api_key=${key}&language=en-US&page=${pageNum}`
// 		)
// 			.then((response) => {
...
// 		dispatch(loading())
// 		fetch(
// 			`https://api.themoviedb.org/3/tv/${id}/recommendations?api_key=880bbec69207f7697602ce098c1da63e&language=en-US&page=${pageNum}`
// 		)
// 			.then((response) => {
// 				return response.json()
// 			})
